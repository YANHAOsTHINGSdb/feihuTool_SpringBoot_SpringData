	...
	<script>
		$(function() {
			$("#chuquan_download_btn").click(function() {
			    $("#fbean").attr("action","http://localhost:8080/chuquan_download");
			    $("#fbean").submit();
			});
		});
	</script>
				...
				<div id="nav-wrapper">
					<nav>
						<div>
							<h2>行情补全</h2>
							<ul>
								<li><a href="http://localhost:8080/HangQing">飞狐导入行情数据下载</a>
								</li>
							</ul>
						</div>
						<div>
							<h2>除权补全</h2>
							<ul>
								<li><a href="http://localhost:8080/ChuQuan">飞狐导入除权数据下载</a>
								</li>
							</ul>
						</div>
						<div>
							<h2>财务补全</h2>
							<ul>
								<li><a href="http://localhost:8080/CaiWu">飞狐导入财务数据下载</a>
								</li>
							</ul>
						</div>
